-- Добавить колонки карточки опоры/оборудования и дефектов, если их ещё нет.
-- Выполнить при ошибке: column pole.card_comment / equipment.card_comment does not exist
...
ALTER TABLE equipment ADD COLUMN IF NOT EXISTS defect_attachment TEXT;
ALTER TABLE equipment ADD COLUMN IF NOT EXISTS card_comment TEXT;
