...
class PowerLineCIMObject(CIMObject):
    ...
    def __init__(
        ...
        balance_ownership: Optional[str] = None,
        alcs_ref: Optional[str] = None,
    ):
        super().__init__(mrid, name)
        ...
        self.balance_ownership = balance_ownership
        self.alcs_ref = alcs_ref
    ...
    def to_cim_dict(self) -> Dict[str, Any]:
        ...
        if self.dispatcher_name:
            result["me:Line.dispatcherName"] = self.dispatcher_name
        if self.region_uid:
            result["me:Line.regionUid"] = self.region_uid
        if self.balance_ownership:
            result["me:Line.organisationRoles"] = self.balance_ownership
        if self.alcs_ref:
            result["me:Line.equipments"] = self.alcs_ref
...
class LineSectionCIMObject(CIMObject):
    ...
    def to_cim_dict(self) -> Dict[str, Any]:
        ...
        if self.conductor_type:
            ...
            result["me:Equipment.nameplate"] = self.conductor_type
...
class ConductingEquipmentCIMObject(CIMObject):
    ...
    def __init__(
        ...
        identified_object_description: Optional[str] = None,
        nameplate: Optional[str] = None,
        tm_code: Optional[str] = None,
        object_subtype: Optional[str] = None,
        pole_count: Optional[int] = None,
        parent_object_ref: Optional[str] = None,
        parent_main_equipment_pole_ref: Optional[str] = None,
        nominal_voltage_kv: Optional[float] = None,
        nominal_breaking_current_ka: Optional[float] = None,
        own_trip_time_sec: Optional[float] = None,
        emergency_current_a: Optional[float] = None,
        continuous_current_a: Optional[float] = None,
        arrester_type: Optional[str] = None,
    ):
        super().__init__(mrid, name)
        ...
        self.identified_object_description = identified_object_description
        self.nameplate = nameplate
        self.tm_code = tm_code
        self.object_subtype = object_subtype
        self.pole_count = pole_count
        self.parent_object_ref = parent_object_ref
        self.parent_main_equipment_pole_ref = parent_main_equipment_pole_ref
        self.nominal_voltage_kv = nominal_voltage_kv
        self.nominal_breaking_current_ka = nominal_breaking_current_ka
        self.own_trip_time_sec = own_trip_time_sec
        self.emergency_current_a = emergency_current_a
        self.continuous_current_a = continuous_current_a
        self.arrester_type = arrester_type
    ...
    def to_cim_dict(self) -> Dict[str, Any]:
        ...
        if self.name:
            result["IdentifiedObject.name"] = self.name
        if self.identified_object_description:
            result["IdentifiedObject.description"] = self.identified_object_description
        if self.nameplate:
            result["me:Equipment.nameplate"] = self.nameplate
        if self.equipment_type and self.cim_class != "Disconnector":
            # Для разъединителя в эталонном FullModel атрибут не используется.
        ...
        if self.i_th is not None:
            result["me:ConductingEquipment.iTh"] = self.i_th
        if self.ip_max is not None:
            result["me:ConductingEquipment.ipMax"] = self.ip_max
        if self.t_th is not None:
            result["me:ConductingEquipment.tTh"] = self.t_th
        if self.normal_open is not None:
            result["Switch.normalOpen"] = self.normal_open
        if self.retained is not None:
            result["Switch.retained"] = self.retained
        if self.tm_code:
            result["me:ConductingEquipment.tmCode"] = self.tm_code
        if self.object_subtype:
            result["me:ConductingEquipment.objectSubtype"] = self.object_subtype
        if self.pole_count is not None:
            result["me:ConductingEquipment.poleCount"] = self.pole_count
        if self.parent_object_ref:
            result["me:ConductingEquipment.parentObjectRef"] = self.parent_object_ref
        if self.parent_main_equipment_pole_ref:
            result["me:ConductingEquipment.parentMainEquipmentPoleRef"] = self.parent_main_equipment_pole_ref
        if self.nominal_voltage_kv is not None:
            result["me:ConductingEquipment.nominalVoltageKv"] = self.nominal_voltage_kv
        if self.nominal_breaking_current_ka is not None:
            result["me:ConductingEquipment.nominalBreakingCurrentKa"] = self.nominal_breaking_current_ka
        if self.own_trip_time_sec is not None:
            result["me:ConductingEquipment.ownTripTimeSec"] = self.own_trip_time_sec
        if self.emergency_current_a is not None:
            result["me:ConductingEquipment.emergencyCurrentA"] = self.emergency_current_a
        if self.continuous_current_a is not None:
            result["me:ConductingEquipment.continuousCurrentA"] = self.continuous_current_a
        if self.arrester_type:
            result["me:ConductingEquipment.arresterType"] = self.arrester_type
        return result
...
class PoleCIMObject(CIMObject):
    ...
    def to_cim_dict(self) -> Dict[str, Any]:
        ...
        if self.construction:
            result["me:Pole.construction"] = self.construction
        if self.rated_voltage is not None:
            result["me:Pole.ratedVoltage"] = self.rated_voltage
        if self.material:
