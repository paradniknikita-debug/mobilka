              ...
              child: Column(
                ...
                children: [
                  ...
                  _PatrolMainButton(
                    ...
                    title: 'НОВЫЙ ОБХОД',
                    subtitle: activeSession != null ? 'СНАЧАЛА ЗАВЕРШИТЕ ТЕКУЩИЙ' : 'НАЧАТЬ СЕССИЮ',
                    onPressed: () {
                      if (activeSession != null) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Нельзя начать новый обход, пока не завершён текущий.'),
