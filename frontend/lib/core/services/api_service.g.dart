...
class _ApiService implements ApiService {
  ...
  Future<List<PowerLine>> getPowerLines() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<PowerLine>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<PowerLine> createPowerLine(PowerLineCreate powerLineData) async {
    ...
    final _options = _setStreamType<PowerLine>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<Equipment>> getPoleEquipment(int poleId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<Equipment>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<Substation> createSubstation(SubstationCreate substationData) async {
    ...
    final _options = _setStreamType<Substation>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
