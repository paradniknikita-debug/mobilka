...
class Equipment {
  ...
  final bool? retained;
  @JsonKey(name: 'identified_object_description')
  final String? identifiedObjectDescription;
  final String? nameplate;
  @JsonKey(name: 'psr_subtype')
  final String? psrSubtype;
  @JsonKey(name: 'installation_display_name')
  final String? installationDisplayName;
  @JsonKey(name: 'tm_code')
  final String? tmCode;
  @JsonKey(name: 'object_subtype')
  final String? objectSubtype;
  @JsonKey(name: 'pole_count')
  final int? poleCount;
  @JsonKey(name: 'parent_object_ref')
  final String? parentObjectRef;
  @JsonKey(name: 'parent_main_equipment_pole_ref')
  final String? parentMainEquipmentPoleRef;
  @JsonKey(name: 'nominal_voltage_kv')
  final double? nominalVoltageKv;
  @JsonKey(name: 'nominal_breaking_current_ka')
  final double? nominalBreakingCurrentKa;
  @JsonKey(name: 'own_trip_time_sec')
  final double? ownTripTimeSec;
  @JsonKey(name: 'emergency_current_a')
  final double? emergencyCurrentA;
  @JsonKey(name: 'continuous_current_a')
  ...
  Equipment copyWith({
    ...
    bool? normalOpen,
    bool? retained,
    String? identifiedObjectDescription,
    String? nameplate,
    String? psrSubtype,
    ...
    int? poleCount,
    String? parentObjectRef,
    String? parentMainEquipmentPoleRef,
    double? nominalVoltageKv,
    double? nominalBreakingCurrentKa,
    double? ownTripTimeSec,
